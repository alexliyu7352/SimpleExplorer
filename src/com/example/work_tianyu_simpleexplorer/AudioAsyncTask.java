...
public class AudioAsyncTask extends AsyncTask<File, String, ArrayList<String>>{
	...
	public AudioAsyncTask(Context mContext, ListView mListView, TextView mTextView, ArrayList<String> data) {
		super();
	...
	protected void onPostExecute(ArrayList<String> result) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				intent.setDataAndType(Uri.fromFile(audioList.get(position)), "audio/*");
